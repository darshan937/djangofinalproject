...
from .forms import CustomerRegistrationForm, CustomerLoginForm, CheckoutForm, ProductForm, PasswordForgotForm, \
    PasswordResetForm
from .models import *
...
class CheckoutView(EcomMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        if cart_id:
            ...
            order = form.save()
            if pm == "Khalti":
                return redirect(reverse("app:khaltirequest") + "?o_id=" + str(order.id))
        else:
...
class KhaltiVerifyView(View):
    def get(self, request, *args, **kwargs):
        ...
        headers = {
            "Authorization": "Key test_secret_key_173e488499a04c68965dec75de7b4752"
        }
